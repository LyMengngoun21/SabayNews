...
function Entertainmentcontent() {
  ...
  return (
    <div className="relative w-full md:container">
      <Tittle
        title="កម្សាន្ត"
        bordercolor="border-flamingo-500"
        bgcolor="bg-flamingo-500"
      />
      <div className="shadow-black-500/50 grid h-auto w-full grid-cols-6 gap-3 px-5 shadow-md">
        ...
        <div className="col-span-6 w-full pb-5 sm:col-span-6 md:col-span-3 md:grid lg:col-span-4 overflow-x-scroll md:overflow-x-hidden">
