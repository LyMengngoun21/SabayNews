  ...
  const Technologydata = [
    {
      ...
      title:
        "បវរកញ្ញា ម៉ិកស៊ិក ម្នាក់ឆក់ចរន្តអគ្គិសនីដាច់ផ្ងារ អំឡុងពេលឡើងប្រកួតលើកឆាក អំឡុងពេលឡើងប្រកួតលើកឆាក",
    },
    {
    ...
    <div className="w-full md:container">
      <div className="relative">
        ...
        <div className="shadow-black-500/50 grid h-auto w-full grid-cols-6 gap-3 px-5 shadow-md">
          ...
          <div className="col-span-6 w-full overflow-x-scroll pb-6 sm:col-span-6 md:col-span-3 md:grid md:overflow-x-hidden lg:col-span-4">
